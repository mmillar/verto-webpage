...
$(document).ready(function() {
	...
	$("a").click(function(event) {
		...
		var tgt = this.href;
		var c = tgt.charAt(tgt.length-1);
		if (c != "#" && this.href != window.location) {
			linkLocation = this.href;
			$("#content").animate({left: "-100%"}, "slow", redirectPage);
		}
	});
...
<div id="wrapper">
    ...
    <?php } ?>
	<div id="header">
		<div class="col-full" style="padding-top: 0; padding-bottom: 0;">
			<div id="logo">
		    <?php
...
?>
	        ...
	        <?php }; ?>
				...
				<span style="font-family: 'Georgia', serif; font-size: 18px; position: relative; top: 48px; text-shadow: 0 1px 0 #aaa;">Technology Empowering People</span>
...
?>
				<ul id="main-nav" class="nav fl" style="color: #fff; text-shadow: 1px 0px #000000;">
					<?php

...
class Woo_Widget_Component extends WP_Widget {
	...
	function Woo_Widget_Component () {
		...
		$this->woo_widget_componentslist = array(
												'homepage-mini-features' => __( 'Mini-Features', 'woothemes'),
												'homepage-blog' => __( 'Blog', 'woothemes' ),
												'homepage-blog-alt' => __( 'Blog Alt', 'woothemes' ),					
												'homepage-feedback' => __( 'Feedback', 'woothemes' ), 
												'homepage-portfolio' => __( 'Portfolio', 'woothemes' )
												);
	...
	function widget( $args, $instance ) {  
		...
		if ( $component != '' ) { locate_template( 'includes/' . $component . '.php', true ); }
